...
class BooksController extends AbstractFOSRestController
{
    ...
    public function editAction(
        ...
        if ($form->isValid()) {
            ...
            $em->persist($book);
            $em->flush();
            // => porque doctrine conserva los indices al añadir o eliminar algo dentro de un array, porque sino devuleve siempre un objeto, asi las categories sea un array. Con el refresh lo refrescamos y devuelve como objeto.
            $em->refresh($book);
            return $book;
        }
        return $form;
